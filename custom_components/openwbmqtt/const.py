...
BINARY_SENSORS_GLOBAL = [
    ...
    openwbBinarySensorEntityDescription(
        key="system/boot_done",
        name="Bootvorgang abgeschlossen",
        entity_category=EntityCategory.DIAGNOSTIC,
        device_class=None,
        icon="mdi:check_network_outline
]
...
# adapted for OpenWB 2.0 (not complete)
SELECTS_GLOBAL = [
#    openwbSelectEntityDescription(
#        key="general/chargemode_config",
#        entity_category=EntityCategory.CONFIG,
#        name="Lademodus",
#        valueMapCurrentValue={
#            0: "Sofort-Laden",             # instant_charging
#            1: "PV-Laden",                 # pv_charging
#            2: "Geplantes Laden",          # scheduled_charging
#            3: "Standby",                  # standby
#            4: "Stop",                     # stop
#            5: "Zeit-Laden",               # time_charging         --> what's the difference between "time" and "scheduled"
#        },
#        valueMapCommand={
#            "Sofort-Laden": 0,
#            "PV-Laden": 1,
